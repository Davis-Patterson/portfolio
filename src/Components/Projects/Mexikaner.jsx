...
import Background from '/src/assets/gd/MXbackground.png';
import Img1 from '/src/assets/gd/MXintermission.png';
import Gif1 from '/src/assets/gd/MXintermission.gif';
import Gif1Comp from '/src/assets/gd/MXintermission-comp.gif';
import Img2 from '/src/assets/gd/MXcountdown.png';
import Gif2 from '/src/assets/gd/MXcountdown.gif';
import Gif2Comp from '/src/assets/gd/MXcountdown-comp.gif';
import Img3 from '/src/assets/gd/MXoverlay.png';
import Gif3 from '/src/assets/gd/MXoverlay.gif';
import Gif3Comp from '/src/assets/gd/MXoverlay-comp.gif';
import descriptions from '/src/Util/Mexikaner.json';
import Progress from '../Progress';

const Mexikaner = ({ activeProject, darkMode }) => {
  ...
  const blueStyle = {
    width: activeProject === 'mexikaner' ? '50px' : '200px',
    opacity: activeProject === 'mexikaner' ? '100%' : '0%',
  };
          ...
          <>
            ...
            <div className='project-info' id='black-project-info'>
              <div className='desc-box' id='black-desc-box'>
                <p className='mini-desc' id='black-desc'>
                  Developed branding and stream assets for The Mexikaner on
                  Twitch. Contact me if you're interested in elevating the look
                  of your stream. You can view
                  <em> The Mexikaner</em> on Twitch or on Instagram here:
                </p>
              </div>
            </div>
            <div className='link-box'>
              <a
                ...
                href='https://www.twitch.tv/the_mexikaner'
              >
                Twitch
              </a>
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                href='https://www.instagram.com/the.mexikaner.gaming/'
              >
                Instagram
              </a>
            </div>
